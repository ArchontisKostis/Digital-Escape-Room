...
public class Storyteller {
    ...
    private String GHelpMsg1 = "Κοίτα προσεκτικά τις εικόνες. Μπορείς να ψάξεις και στο διαδίκτυο αν δεν θυμάσαι τους άθλους του Ηρακλή";
    private String GHelp2 = "Μπορείς να ψάξεις και στο διαδίκτυο αν δεν θυμάσαι τις τιμωρίες τους (Του Προμηθέα είναι η χειρότερη)";
